...
public class WebSecurityConfig {
    ...
    private UserService userService;
    private CustomOAuth2UserService AouthuserService;

    public WebSecurityConfig(UserService userService, CustomOAuth2UserService aouthuserService) {
        this.userService = userService;
        AouthuserService = aouthuserService;
    }
                ...
                .oauth2Login(oauth -> oauth
                        ...
                        .successHandler(new AuthenticationSuccessHandler() {
                            ...
                            public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
                                ...
                                // Process OAuth login success
                                userService.processOAuthPostLogin(authentication.getName());
                                response.sendRedirect("/UserProfile.html"); // Redirect to UserProfile.html after successful login
                            }
                        })
                )
                .addFilterAfter(bearerTokenAuthFilter(), BasicAuthenticationFilter.class); // Add bearer token filter
